...
const PAGES = [
  { slug: 'home', label: 'Home Page', sections: ['hero', 'trust', 'why-choose'] },
  { slug: 'about-us', label: 'About Us Page', sections: ['intro', 'what-we-offer', 'values', 'why-choose-us', 'founder'] },
  { slug: 'our-process', label: 'Our Process Page', sections: ['intro', 'steps'] },
  { slug: 'contact-us', label: 'Contact Us Page', sections: ['info'] },
  { slug: 'why-choose-us', label: 'Why Choose Us Page', sections: ['main'] },
];
      ...
      <div className="flex items-start justify-between mb-8">
        <div>
          ...
          <p className="text-gray-500 mt-1 text-sm">
            Edit all page text, headings, lists, process steps, office addresses, and more. All changes auto-save to the database.
          </p>
        </div>
